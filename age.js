...
// Add the y axis
  ...
  const coloursAgeStack = ['#fbb4ae','#b3cde3','#ccebc5','#decbe4','#fed9a6','#ffffcc','#e5d8bd','#fddaec','#f2f2f2'];
  ...
  //   .style("opacity", 0);
    ...
    function showAgePercentStack(data){
    ...
    let bars = svgAgeStack
      ...
      .attr("x", function (d) {return x(d.data.Year); })
      .attr("y", function (d) { 
        let total = d3.sum(d3.values(d.data));
        return y(d[1]) ;})
